...
/**
 * Credit for the basis of this class goes to Patrick Gotthardt and
 * http://www.jroller.com/ for enhancements to the base JTabbedPane class.
 * 
...
public class TabInputHandler extends MouseInputAdapter implements KeyListener, ClipboardOwner {
	...
	public void mouseDragged(MouseEvent e) {
		...
		if (targetTabIndex != -1 && targetTabIndex != draggedTabIndex) {
			...
			tabPane.insertTab(tabPane.getTitleAt(draggedTabIndex), tabPane.getIconAt(draggedTabIndex),
					tabPane.getComponentAt(draggedTabIndex), tabPane.getToolTipTextAt(draggedTabIndex),
	...
	/**
	 * Places a String on the clip-board, and make this class the owner of the
